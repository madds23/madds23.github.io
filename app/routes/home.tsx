...
function HomeBody() {
    return <main className="bg-white p-4 md:p-10 text-left text-red-950 text-2xl font-sans font-medium lg:px-16 xl:px-28">
        ...
        <SideBySide headerImgSrc="/meet_madds.png" textContent="Hi! I’m Madds, your (hopefully) new favorite podcast host. I recently finished my Bachelor’s of Arts in Music and have studied music for nearly 16 years! This podcast began as a senior project in my very last semester, but..." imgSrc="/madds1.webp" imgSide="left" >
            <div className="m-4 flex justify-center items-center md:basis-1/3">
