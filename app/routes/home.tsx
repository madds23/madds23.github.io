...
function HomeBody() {
  return <main className="bg-white p-4 md:p-10 text-left text-red-950 text-2xl font-sans font-medium lg:px-16 xl:px-28">
    ...
    <SideBySide headerImgSrc="/meet_madds.png" textContent="Hi! I'm Madds, your new favorite podcast host. I have been studying music for 15 years now and am finishing a degree in music! I actually started this podcast as a senior project for my last semester of school, but I hope to continue after my first season. I hope..." imgSrc="/madds1.webp" imgSide="left" >
      <div className="m-4 flex justify-center items-center md:basis-1/3">
